...
export default function page() {
  return (
    ...
    >
      ...
      <a href="/pdf/others/sponsorship_opportunity.pdf" target="_blank" className='text-blue-900 hover:underline hover:border-b-0' style={{borderBottom:0}}>Download Sponsorship opportunities for BES Expo 2026</a>
    </div>
  );
}
