...
import MobileBottomNavWrapper from "../UIComponent/MobileBottomNavWrapper";

export default function layout({ children }: any) {
  return (
    <div
      className="flex flex-col md:flex-row gap-[10px] p-0 px-6 md:p-4 pb-20 md:pb-4 bg-[#f2f2f2] flex-1 justify-between min-h-full relative"
      style={{
    ...
    >
      ...
      <MobileBottomNavWrapper title="About BES">
